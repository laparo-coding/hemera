...
Centralized design tokens for Hemera Design System.
...
export const shadows = {
  ...
  heroOverlay: 'linear-gradient(to bottom, rgba(22, 64, 77, 0.3), rgba(22, 64, 77, 0.7))',
} as const;
...
<Box sx={{ bgcolor: colors.cream, py: spacing.sectionPy }}>
  <Typography sx={{ fontFamily: typography.heading, color: colors.petrol }}>
    Title
  </Typography>
</Box>
```
...
### Course Level Badge
```typescript
import { courseLevelColors } from '@/lib/design-tokens';
...
<Chip 
  ...
  sx={{ bgcolor: levelStyle.bg, color: levelStyle.text }}
/>
```
